...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 18, paddingTop: 18, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: '#202024', backgroundColor: '#09090B' },
  ...
  dateSeparatorText: { color: '#71717A', backgroundColor: '#141417', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 12, fontSize: 11, fontWeight: '700' },
  ...
  bubbleMine: { backgroundColor: '#EF4444', borderBottomRightRadius: 5, borderWidth: 1, borderColor: '#EF4444' },
  bubbleOther: { backgroundColor: '#18181B', borderWidth: 1, borderColor: '#242428', borderBottomLeftRadius: 5 },
  ...
  input: { flex: 1, minHeight: 48, backgroundColor: '#18181B', borderWidth: 1, borderColor: '#242428', borderRadius: 24, paddingHorizontal: 16, color: '#FFFFFF', fontSize: 15, outlineStyle: 'none' as any },
