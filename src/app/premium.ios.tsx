...
const copy = {
  en: {
    ...
    body: 'This iOS version does not sell digital subscriptions inside the app. If Premium is active on your SipMate account, your Premium features unlock automatically after you sign in.',
  ...
  de: {
    ...
    body: 'Diese iOS-Version verkauft keine digitalen Abos innerhalb der App. Wenn Premium auf deinem SipMate-Konto aktiv ist, werden deine Premium-Funktionen nach der Anmeldung automatisch freigeschaltet.',
  ...
  hr: {
    ...
    body: 'Ova iOS verzija ne prodaje digitalne pretplate unutar aplikacije. Ako je Premium aktivan na tvom SipMate računu, Premium mogućnosti se automatski otključavaju nakon prijave.',
...
export default function PremiumIosScreen() {
