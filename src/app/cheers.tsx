...
const styles = StyleSheet.create({
  ...
  statBox: { flex: 1, backgroundColor: 'rgba(18,18,21,0.96)', borderWidth: 1, borderColor: '#38282B', borderRadius: 20, paddingVertical: 15, alignItems: 'center', marginHorizontal: 4, shadowColor: '#000000', shadowOpacity: 0.15, shadowRadius: 12, shadowOffset: { width: 0, height: 6 }, elevation: 2 },
  ...
  chatButton: { backgroundColor: '#DC2626', paddingHorizontal: 15, paddingVertical: 12, borderRadius: 17, marginLeft: 12, borderWidth: 1, borderColor: '#F87171', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.16, shadowRadius: 10, elevation: 3 },
  chatButtonText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900' },
  unlockButton: { backgroundColor: '#F59E0B', paddingHorizontal: 15, paddingVertical: 12, borderRadius: 20, marginLeft: 12 },
  unlockButtonText: { color: '#09090B', fontSize: 11, fontWeight: '900' },
  emptyBox: { alignItems: 'center', paddingVertical: 70 },
  emptyCard: { backgroundColor: '#121215', borderWidth: 1, borderColor: '#342326', borderRadius: 26, paddingVertical: 42, paddingHorizontal: 25, alignItems: 'center', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.07, shadowRadius: 24, elevation: 3 },
