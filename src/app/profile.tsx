    ...
    <SafeAreaView style={styles.screen}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          ...
          <Pressable style={styles.infoButton} onPress={() => router.push('/community-guidelines')}><View style={styles.buttonContent}><Text style={styles.buttonEmoji}>🤝</Text><Text style={styles.infoButtonText}>{text.communityGuidelines}</Text></View></Pressable>
          <Pressable style={styles.infoButton} onPress={() => router.push('/privacy')}><View style={styles.buttonContent}><Text style={styles.buttonEmoji}>🔒</Text><Text style={styles.infoButtonText}>{text.privacyPolicy}</Text></View></Pressable>
