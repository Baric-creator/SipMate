...
const styles = StyleSheet.create({
  ...
  profileAvatarFallbackText: { color: '#FFFFFF', fontSize: 48, fontWeight: '900' },
  name: { color: '#FFFFFF', fontSize: 30, fontWeight: '900', marginTop: 18 },
  city: { color: '#A1A1AA', marginTop: 6 },
  premiumBadge: { marginTop: 10, backgroundColor: '#F59E0B', borderWidth: 1, borderColor: '#FBBF24', paddingHorizontal: 13, paddingVertical: 6, borderRadius: 999 },
  premiumBadgeText: { color: '#09090B', fontSize: 11, fontWeight: '900', letterSpacing: 0.8 },
  statusBadge: { marginTop: 14, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999, borderWidth: 1 },
  statusBadgeActive: { backgroundColor: '#052E16', borderColor: '#22C55E' },
  statusBadgeInactive: { backgroundColor: '#27272A', borderColor: '#52525B' },
  statusBadgeText: { fontSize: 11, fontWeight: '900' },
  statusTextActive: { color: '#4ADE80' },
  statusTextInactive: { color: '#A1A1AA' },
  section: { width: '100%', backgroundColor: '#27272A', padding: 16, borderRadius: 18, marginTop: 18 },
  label: { color: '#71717A', fontSize: 10, fontWeight: '900', letterSpacing: 1.3 },
  drinkChip: { marginTop: 10, backgroundColor: '#09090B', borderWidth: 1, borderColor: '#DC2626', borderRadius: 16, paddingHorizontal: 14, paddingVertical: 12 },
  drink: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' },
  bio: { color: '#D4D4D8', fontSize: 14, lineHeight: 21, marginTop: 7 },
  premiumButton: { width: '100%', marginTop: 24, backgroundColor: '#F59E0B', borderWidth: 1, borderColor: '#FBBF24', paddingVertical: 16, borderRadius: 22, alignItems: 'center' },
  premiumButtonText: { color: '#09090B', fontSize: 15, fontWeight: '900', letterSpacing: 0.5 },
  editButton: { width: '100%', marginTop: 14, backgroundColor: '#DC2626', paddingVertical: 16, borderRadius: 22, alignItems: 'center' },
  editButtonText: { color: '#FFFFFF', fontSize: 15, fontWeight: '900' },
  ...
  deleteText: { color: '#FCA5A5', fontSize: 13, fontWeight: '900', letterSpacing: 0.5 },
});
