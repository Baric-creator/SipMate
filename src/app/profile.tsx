...
const styles = StyleSheet.create({
  ...
  cardPressed: { transform: [{ scale: 0.985 }], borderColor: '#EF4444', backgroundColor: '#181214' },
  ...
  topAction: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#141013', borderWidth: 1, borderColor: '#6B2A30', alignItems: 'center', justifyContent: 'center', shadowColor: '#EF4444', shadowOpacity: 0.14, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 3 },
  topActionText: { fontSize: 16 },

  hero: { alignItems: 'center', paddingTop: 6, paddingBottom: 22 },
  avatarShell: { position: 'relative', width: 128, height: 128, borderRadius: 64, padding: 4, backgroundColor: '#151518', borderWidth: 2, borderColor: '#6B2A30', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.16, shadowRadius: 22, elevation: 5 },
  ...
  completionCard: { backgroundColor: 'rgba(18,14,16,0.96)', borderWidth: 1, borderColor: '#6B2A30', borderRadius: 24, padding: 17, marginBottom: 12, shadowColor: '#EF4444', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.13, shadowRadius: 20, elevation: 4 },
  ...
  infoCard: { backgroundColor: 'rgba(18,14,16,0.96)', borderWidth: 1, borderColor: '#6B2A30', borderRadius: 24, padding: 18, marginBottom: 12, shadowColor: '#EF4444', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.13, shadowRadius: 20, elevation: 4 },
  infoHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  infoEyebrow: { color: '#8A7D80', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 },
  ...
  discordCard: { backgroundColor: 'rgba(16,15,21,0.97)', borderWidth: 1, borderColor: '#6B2A30', borderRadius: 24, padding: 18, marginBottom: 12, shadowColor: '#EF4444', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.13, shadowRadius: 20, elevation: 4 },
  ...
  settingsCard: { backgroundColor: 'rgba(18,14,16,0.96)', borderWidth: 1, borderColor: '#6B2A30', borderRadius: 24, overflow: 'hidden', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.13, shadowRadius: 20, elevation: 4 },
  settingsRow: { minHeight: 58, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#362126' },
  ...
  chevron: { color: '#6B4A4E', fontSize: 26, fontWeight: '300' },

  legalLinks: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginTop: 16 },
  legalLink: { paddingHorizontal: 11, paddingVertical: 8, borderRadius: 999, backgroundColor: '#141013', borderWidth: 1, borderColor: '#5A252B', shadowColor: '#EF4444', shadowOpacity: 0.08, shadowRadius: 8, elevation: 2 },
  legalLinkText: { color: '#7B6D70', fontSize: 9, fontWeight: '700', fontFamily: 'sans-serif' },
});
