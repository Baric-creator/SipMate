...
export default function PremiumScreen() {
  ...
  function getOfferTheme(code: string, billingPeriod: 'monthly' | 'yearly') {
    if (code === 'founders_yearly') return { border: '#F5B942', glow: 'rgba(245,185,66,0.32)', bg: '#1C1810' };
    if (code === 'early_yearly') return { border: '#3B82F6', glow: 'rgba(59,130,246,0.30)', bg: '#101724' };
    if (code === 'standard_yearly') return { border: '#FB5A58', glow: 'rgba(251,90,88,0.28)', bg: '#1D1214' };
    if (billingPeriod === 'monthly') return { border: '#EF4444', glow: 'rgba(239,68,68,0.30)', bg: '#1D1214' };
    return { border: '#EF4444', glow: 'rgba(239,68,68,0.30)', bg: '#18181B' };
  }
...
const styles = StyleSheet.create({
  ...
  ambientOrb: { position: 'absolute', borderRadius: 999, backgroundColor: 'rgba(245,158,11,0.08)', shadowColor: '#F59E0B', shadowOpacity: 0.16, shadowRadius: 50, shadowOffset: { width: 0, height: 0 }, elevation: 1 },
  ambientOrbTop: { width: 260, height: 260, top: -110, right: -120 },
  ambientOrbBottom: { width: 230, height: 230, top: 560, left: -140, backgroundColor: 'rgba(220,38,38,0.07)', shadowColor: '#EF4444' },
  scanAccent: { position: 'absolute', top: 106, right: 24, width: 74, height: 1, backgroundColor: 'rgba(251,191,36,0.34)' },
  scroll: { flex: 1, backgroundColor: 'transparent' }, content: { width: '100%', maxWidth: 760, alignSelf: 'center', paddingHorizontal: 20, paddingTop: 30, paddingBottom: 50 }, header: { alignItems: 'center', marginBottom: 24 }, logo: { color: '#EF4444', fontSize: 17, fontWeight: '900', marginBottom: 14 }, title: { color: '#FFFFFF', fontSize: 34, fontWeight: '900', textAlign: 'center' }, subtitle: { color: '#A1A1AA', fontSize: 14, textAlign: 'center', marginTop: 8, lineHeight: 20 },
  heroCard: { backgroundColor: '#151316', borderWidth: 1, borderColor: '#6B3439', borderRadius: 30, padding: 26, alignItems: 'center', marginBottom: 20, shadowColor: '#EF4444', shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.12, shadowRadius: 28, elevation: 4 }, heroIcon: { fontSize: 44 }, heroTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', marginTop: 12, letterSpacing: 0.8 }, heroText: { color: '#A1A1AA', fontSize: 14, textAlign: 'center', lineHeight: 21, marginTop: 9, maxWidth: 460 },
  featuresCard: { backgroundColor: 'rgba(18,18,21,0.97)', borderRadius: 24, padding: 20, borderWidth: 1, borderColor: '#332F34', marginBottom: 28 }, sectionTitle: { color: '#71717A', fontSize: 11, fontWeight: '900', letterSpacing: 1.2, marginBottom: 14 }, featureRow: { flexDirection: 'row', alignItems: 'center', minHeight: 52, borderBottomWidth: 1, borderBottomColor: '#27272A' }, featureIcon: { width: 34, alignItems: 'center' }, featureIconText: { fontSize: 17 }, featureText: { flex: 1, color: '#E4E4E7', fontSize: 14, fontWeight: '700', paddingHorizontal: 8 }, check: { color: '#22C55E', fontSize: 17, fontWeight: '900' }, chooseTitle: { color: '#FFFFFF', fontSize: 23, fontWeight: '900', marginBottom: 14 }, loadingText: { color: '#A1A1AA', textAlign: 'center', paddingVertical: 30 }, emptyCard: { backgroundColor: '#141417', borderRadius: 20, padding: 20 }, emptyText: { color: '#A1A1AA', textAlign: 'center' },
  offerCard: { position: 'relative', overflow: 'hidden', backgroundColor: '#141417', borderWidth: 1.5, borderColor: '#45454D', borderRadius: 26, padding: 22, marginBottom: 16, shadowColor: '#000000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.20, shadowRadius: 20, elevation: 3 }, offerShine: { position: 'absolute', top: -90, bottom: -90, left: -80, width: 82, opacity: 0.95 }, offerCardFeatured: { borderWidth: 2, borderColor: '#FBBF24', backgroundColor: '#1C1917', shadowColor: '#F59E0B', shadowOpacity: 0.18, shadowRadius: 22, elevation: 5 }, offerTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }, offerHeading: { flex: 1, paddingRight: 10 }, offerBadge: { color: '#F59E0B', fontSize: 11, fontWeight: '900', letterSpacing: 0.7 }, offerName: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', marginTop: 5 }, bestValueBadge: { backgroundColor: '#F59E0B', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, shadowColor: '#F59E0B', shadowOpacity: 0.18, shadowRadius: 8, elevation: 2 }, bestValueText: { color: '#09090B', fontSize: 9, fontWeight: '900' }, priceRow: { flexDirection: 'row', alignItems: 'flex-end', marginTop: 20 }, price: { color: '#FFFFFF', fontSize: 35, fontWeight: '900' }, period: { color: '#A1A1AA', fontSize: 12, marginLeft: 7, marginBottom: 6 }, originalPrice: { color: '#71717A', fontSize: 12, marginTop: 4 }, spotsBox: { alignSelf: 'flex-start', marginTop: 14, backgroundColor: '#450A0A', borderWidth: 1, borderColor: '#DC2626', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12 }, spotsText: { color: '#FCA5A5', fontSize: 12, fontWeight: '900' }, offerDescription: { color: '#A1A1AA', fontSize: 13, lineHeight: 19, marginTop: 15 }, selectButton: { width: '100%', backgroundColor: '#DC2626', paddingVertical: 16, borderRadius: 19, alignItems: 'center', marginTop: 20, borderWidth: 1, borderColor: '#F87171', shadowColor: '#EF4444', shadowOffset: { width: 0, height: 7 }, shadowOpacity: 0.18, shadowRadius: 12, elevation: 4 }, selectButtonFeatured: { backgroundColor: '#F59E0B' }, selectButtonText: { color: '#FFFFFF', fontSize: 14, fontWeight: '900', letterSpacing: 0.6 },
  noteCard: { backgroundColor: '#141417', borderWidth: 1, borderColor: '#2F2F34', borderRadius: 20, padding: 18, marginTop: 8 }, noteTitle: { color: '#FFFFFF', fontSize: 14, fontWeight: '900' }, noteText: { color: '#A1A1AA', fontSize: 12, lineHeight: 19, marginTop: 7 }, backButton: { alignSelf: 'center', marginTop: 28, paddingHorizontal: 20, paddingVertical: 12 }, backText: { color: '#EF4444', fontSize: 13, fontWeight: '900' }, footer: { color: '#52525B', textAlign: 'center', fontSize: 11, marginTop: 10 },
  successCard: { marginBottom: 22, padding: 24, borderRadius: 20, borderWidth: 1, borderColor: '#F59E0B', backgroundColor: '#141417', alignItems: 'center' }, successIcon: { fontSize: 42, marginBottom: 10 }, successTitle: { color: '#FBBF24', fontSize: 24, fontWeight: '900', letterSpacing: 1, textAlign: 'center', marginBottom: 8 }, successSubtitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '800', textAlign: 'center', marginBottom: 8 }, successText: { color: '#A1A1AA', fontSize: 14, fontWeight: '600', textAlign: 'center', marginBottom: 20 }, successButton: { width: '100%', backgroundColor: '#DC2626', borderRadius: 14, paddingVertical: 15, alignItems: 'center' }, successButtonText: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', letterSpacing: 0.8 },
  cancelledCheckoutCard: { marginBottom: 22, padding: 20, borderRadius: 18, borderWidth: 1, borderColor: '#52525B', backgroundColor: '#141417', alignItems: 'center' }, cancelledCheckoutTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '900', letterSpacing: 0.8, textAlign: 'center', marginBottom: 8 }, cancelledCheckoutText: { color: '#A1A1AA', fontSize: 14, fontWeight: '600', lineHeight: 20, textAlign: 'center', marginBottom: 16 }, cancelledCheckoutButton: { width: '100%', backgroundColor: '#27272A', borderRadius: 12, paddingVertical: 13, alignItems: 'center' }, cancelledCheckoutButtonText: { color: '#FFFFFF', fontSize: 14, fontWeight: '900', letterSpacing: 0.7 },
  activePremiumCard: { marginTop: 22, marginBottom: 22, padding: 22, borderRadius: 18, borderWidth: 1, borderColor: '#F59E0B', backgroundColor: '#141417', alignItems: 'center' }, activePremiumBadge: { color: '#FBBF24', fontSize: 14, fontWeight: '900', letterSpacing: 1.2, marginBottom: 12 }, activePremiumPlan: { color: '#FFFFFF', fontSize: 22, fontWeight: '900', textAlign: 'center', marginBottom: 8 }, activePremiumPrice: { color: '#FBBF24', fontSize: 18, fontWeight: '800', marginBottom: 10 }, activePremiumUntil: { color: '#A1A1AA', fontSize: 13, fontWeight: '600', textAlign: 'center', marginBottom: 14 }, cancelNotice: { width: '100%', marginTop: 16, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: '#DC2626', backgroundColor: '#2A1111', alignItems: 'center' }, cancelNoticeTitle: { color: '#EF4444', fontSize: 14, fontWeight: '900', letterSpacing: 0.7, textAlign: 'center', marginBottom: 6 }, cancelNoticeText: { color: '#E4E4E7', fontSize: 13, fontWeight: '600', textAlign: 'center', lineHeight: 19 }, activePremiumUnlocked: { color: '#22C55E', fontSize: 14, fontWeight: '800', marginTop: 14 }, manageSubscriptionButton: { marginTop: 8, marginBottom: 30, borderWidth: 1, borderColor: '#F59E0B', borderRadius: 14, paddingVertical: 15, alignItems: 'center', backgroundColor: '#141417' }, manageSubscriptionText: { color: '#FBBF24', fontSize: 14, fontWeight: '800', letterSpacing: 0.8 },
});
