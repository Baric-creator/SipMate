-- Do not expose precise target distance. Premium custom origins can otherwise be
-- sampled repeatedly to triangulate another user's location.
...
returns table (
  id uuid, name text, age integer, city text, bio text,
  currently_up_for text, is_active boolean, avatar_url text, gender text,
